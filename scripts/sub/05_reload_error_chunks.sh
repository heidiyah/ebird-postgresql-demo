...
CHUNK_DIR="/submission_chunks"               # path to table chunks
LOG_DIR="/submission_chunks/copy_logs"       # path to error logs
DB="ebird"                                 # database name
USER="postgres"                            # database username
TABLE="submission_temp"                      # temporary table name (will isolate rows based on desired primary key later)
