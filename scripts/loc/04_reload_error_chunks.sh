...
CHUNK_DIR="/location_chunks"               # path to table chunks
LOG_DIR="/location_chunks/copy_logs"       # path to error logs
DB="ebird"                                 # database name
USER="postgres"                            # database username
TABLE="loc_temp"                      # temporary table name (will isolate rows based on desired primary key later)
