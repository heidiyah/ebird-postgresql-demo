...
CHUNK_DIR="/var/lib/postgresql/data/heidi/ebd_relJun-2025/observation_normalization"
LOG_DIR="/var/lib/postgresql/data/heidi/ebd_relJun-2025/observation_normalization/copy_logs"
DB="ebird"
USER="postgres"
TABLE="observation_temp"
